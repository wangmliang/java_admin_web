...
var originalValue = {};
var findStaffExtendProperties = window.ctxPaths  + '/staff/findStaffExtendProperties.ajax';
...
$(function() {
	...
	for (var i = 0 ; i < staffExtendProperties.length; i++){
		...
		addRule = $.extend(true,addRule,checkRule);
	}
	validator = $('#modifyInfoForm').validate(addRule);
	// 表单数据加载
	function formLoad() {
