 ...
 * 常见正则表达式帮助类
 * <pre>
 * <b>Title：</b>RegesUtils.java<br/>
 * <b>@author：</b>WML<br/>
 * <b>@date：</b>2017年3月31日 - 下午2:26:56<br/>  
 * <b>@version V1.0</b></br/>
...
public class RegesUtils {
	 ...
	 * 
	 * @param email
	 *            email地址，格式：[email]abc@sina.com[/email]，[email]abc@xxx.com.cn[/email]，xxx代表邮件服务商
	 ...
	 * 
	 * @param url
	 *            格式：[url]http://blog.csdn.net:80/xyang81/article/details/7705960?[/url] 或 [url]http://www.csdn.net:80[/url]
	 * @return 验证成功返回true，验证失败返回false
	 */
	...
	public static void main(String[] args) {
		System.out.println(checkNum("你好:15399705971"));
	}
